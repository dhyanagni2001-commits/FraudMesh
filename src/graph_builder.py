...
def build_entity_graph(df: pd.DataFrame, link_columns=None,
                        max_edges_per_entity: int = 500) -> nx.Graph:
    ...
    max_edges_per_entity caps the number of pairwise edges generated by any
    single entity value (e.g. a very common email domain shared by 50,000
    transactions would otherwise produce ~1.25 billion edges). Entities above
    the cap are treated as too generic to be informative and are skipped —
    this is a standard practical safeguard in entity-resolution graphs.
    """
